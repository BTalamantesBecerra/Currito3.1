...
def main(argv):
    ...
    draw.text((1450, 1650),"a) Circular plot showing BLAST alignments of sample sequenced fragments against the",(0, 0, 0),font=font)
    draw.text((1450, 1700),"    first candidate reference plasmid.",(0, 0, 0),font=font)
    draw.text((1450, 1750),"     First candidate title:",(0, 0, 0),font=font)
    draw.text((1450, 1800),"    " + subjectTitle_1 + ".",(0, 0, 0),font=font)
    
    draw.text((1450, 1900),"b) Circular plot showing BLAST alignments of sample sequenced fragments against the",(0, 0, 0),font=font)
    draw.text((1450, 1950),"    second candidate reference plasmid.",(0, 0, 0),font=font)
    draw.text((1450, 2000),"     Second candidate title:",(0, 0, 0),font=font)
    draw.text((1450, 2050),"    " + subjectTitle_2 + ".",(0, 0, 0),font=font)
    
    draw.text((1450, 2150),"c) Circular plot showing BLAST alignments of sample sequenced fragments against the",(0, 0, 0),font=font)
    draw.text((1450, 2200),"    third candidate reference plasmid.",(0, 0, 0),font=font)
    draw.text((1450, 2250),"     Third candidate title:",(0, 0, 0),font=font)
    draw.text((1450, 2300),"    " + subjectTitle_3 + ".",(0, 0, 0),font=font)
    
    draw.text((1450, 2400),"Explanation of circular plots:",(0, 0, 0),font=font)
    draw.text((1450, 2450),"-Outer black circle represents the candidate reference plasmid with size",(0, 0, 0),font=font)
    draw.text((1450, 2500),"    indicated in basepairs (bp).",(0, 0, 0),font=font)
    draw.text((1450, 2550),"-Middle blue circle shows aligned sequenced fragments obtained by complexity",(0, 0, 0),font=font)
    draw.text((1450, 2600),"    reduced genotyping.",(0, 0, 0),font=font)
    draw.text((1450, 2650),"-Inner green / red circle shows the percentage identity of the alignments. ",(0, 0, 0),font=font)
    draw.text((1450, 2700),"    Values below 95% are red, values equal to or above 95% are green.",(0, 0, 0),font=font)
